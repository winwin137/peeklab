      ...
      >
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Advanced Insights</h2>
            <button 
          ...
          <nav>
            <ul className="space-y-4">
              {[
                { label: 'Phenotype/Genotype', href: '/phenotype' },
                { label: 'Carbs Fats Protein', href: '/macronutrients' },
                { label: 'Vitamins', href: '/vitamins' },
                { label: 'Minerals', href: '/minerals' },
                { label: 'Fiber', href: '/fiber' },
                { label: 'Anti-Oxidants', href: '/antioxidants' },
                { label: 'Glycemic Control', href: '/glycemic-control' },
                { label: 'Advanced Glycemic End Products', href: '/advanced-glycemic' },
                { label: 'Human Body', href: '/human-body' },
                { label: 'HealthSpan', href: '/healthspan' }
              ].map((item) => (
                <li key={item.href}>
                  <a 
                    href={item.href}
